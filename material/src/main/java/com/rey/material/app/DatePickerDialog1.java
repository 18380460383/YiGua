 ...
 */
public class DatePickerDialog1 extends Dialog {
    ...
    public DatePickerDialog1(Context context) {
        super(context, R.style.Material_App_Dialog_DatePicker_Light);
    }

    public DatePickerDialog1(Context context, int style) {
        super(context, style);
    }
     ...
     */
    public DatePickerDialog1 dateRange(int minDay, int minMonth, int minYear, int maxDay, int maxMonth, int maxYear){
     ...
     * @return The DatePickerDialog for chaining methods.
     */
    public DatePickerDialog1 dateRange(long minTime, long maxTime){
     ...
     * @return The DatePickerDialog for chaining methods.
     */
    public DatePickerDialog1 date(int day, int month, int year){
     ...
     * @return The DatePickerDialog for chaining methods.
     */
    public DatePickerDialog1 date(long time){
     ...
     * @return The DatePickerDialog for chaining methods.
     */
    public DatePickerDialog1 onDateChangedListener(OnDateChangedListener listener){
    ...
    public static class Builder extends Dialog.Builder implements OnDateChangedListener {
        ...
        protected Dialog onBuild(Context context, int styleId) {
            DatePickerDialog1 dialog = new DatePickerDialog1(context, styleId);

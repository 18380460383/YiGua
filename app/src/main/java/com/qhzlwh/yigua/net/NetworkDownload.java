...
import com.qhzlwh.yigua.AppContext;
...
*/
    ...
    private static boolean isToastMsg(Context context){
        if(context==AppContext.getInstance()||(null != context && context == AppContext.getInstance().getOneActivity())||(null!=context&&AppContext.getInstance().getOneActivity() instanceof MainActivity)){
            return true;
        }
        return false;
    }

...
public class ShareControl {
     ...
     * @return
     */
    public OnekeyShare getOnekeyShare(final String title, final String text, final Bitmap bitmap, final String url, final String bigImageurl, final String Imageurl, final String siteUrl){
        //关闭sso授权
        ...
        oks.setShareContentCustomizeCallback(new ShareContentCustomizeCallback() {
            ...
            public void onShare(Platform platform, Platform.ShareParams paramsToShare) {
                if(platform.getName().equals(SinaWeibo.NAME)) {
                    ...
                    paramsToShare.setSite("一呱");
                    paramsToShare.setSiteUrl(siteUrl);

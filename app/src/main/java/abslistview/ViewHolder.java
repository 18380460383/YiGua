...
public class ViewHolder
{
    ...
    public ViewHolder setColor(int viewId,String color){
        TextView tv = getView(viewId);
    ...
    public ViewHolder setImage(int viewId,String url){
        ...
        return this;
    }    public ViewHolder setImagecricle(int viewId,String url){
    ...
    {
        View view = getView(viewId);
        Glide.with(mContext).load(backgroundRes).into((ImageView) view);
        return this;
    }

...
import com.example.uu.gaode.drive.DriveRouteDetailActivity;
import com.example.uu.gaode.util.AMapUtil;
import com.example.uu.gaode.util.ToastUtil;
import com.example.uu.gaode.walk.WalkRouteDetailActivity;
...
public class RouteActivity extends AppCompatActivity  implements OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null){
            mStartPoint.setLatitude(bundle.getDouble("startLat"));
            mStartPoint.setLongitude(bundle.getDouble("startLag"));
            mEndPoint.setLatitude(bundle.getDouble("endLat"));
            mEndPoint.setLongitude(bundle.getDouble("endLag"));
        }

package com.example.uu.gaode.busline;
...
public class BuslineActivity extends Activity implements OnMarkerClickListener,
	...
	private String[] itemCitys = { "北京-010", "郑州-0371", "上海-021","成都-028" };
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
		...
		textView= (TextView) findViewById(R.id.stationshow);
		init();
	}
	...
	public void showResultList(List<BusLineItem> busLineItems) {
		...
		busLineDialog.onListItemClicklistener(new OnListItemlistener() {
			...
			public void onListItemClick(BusLineDialog dialog,
				...
				ToastUtil.show(BuslineActivity.this,item.getBusStations().size()+"");
				StringBuffer buffer=new StringBuffer("");
				for(int i=0;i<item.getBusStations().size();i++){
					buffer.append(item.getBusStations().get(i).getBusStationName()+"->");
				}

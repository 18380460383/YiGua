package com.example.uu.gaode.location;
...
public class LocationModeSourceActivity extends Activity implements LocationSource,
		AMapLocationListener,OnCheckedChangeListener ,AMap.OnMapLoadedListener, View.OnClickListener {
	private AMap aMap;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//button= (Button) findViewById(R.id.map_screenshot1);

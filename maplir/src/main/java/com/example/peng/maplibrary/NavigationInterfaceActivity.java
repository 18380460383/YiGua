package com.example.peng.maplibrary;
...
import com.example.peng.maplibrary.util.TTSController;
...
public class NavigationInterfaceActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   Intent intent = getIntent();
        ...
        double startLat =mStartPoint.getLatitude();
        double startLag = mStartPoint.getLongitude();
        double endLat = mEndPoint.getLatitude();
        double endLag = mEndPoint.getLongitude();
        float speed = 30;
